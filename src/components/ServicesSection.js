...
import ServiceSectionItem from '../components/ServicesSectionItem'
    ...
    return (
        <div className="container" style={{color:"white",padding:"10rem 0"}}>
          ...
          <div className="services_allItems">
              <ServiceSectionItem icon={<MdDesktopMac style={{width:"3rem",height:"3rem"}}/>} title="Web Dev" desc="
              ...
              <ServiceSectionItem icon={<MdCode style={{width:"3rem",height:"3rem"}}/>} title="Coding" 
              ...
              />
              <ServiceSectionItem icon={<MdPhonelinkSetup style={{width:"3rem",height:"3rem"}}/>} title="App Dev" 
